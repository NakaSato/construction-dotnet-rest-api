...
namespace dotnet_rest_api.Migrations
{
    ...
    [Migration("20250620223317_AzureProduction")]
    partial class AzureProduction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("dotnet_rest_api.Models.WorkRequestNotification", b =>
                {
                    ...
                    b.ToTable("WorkRequestNotification");
                });
            ...
            modelBuilder.Entity("dotnet_rest_api.Models.ProjectTask", b =>
                {
                    ...
                    b.HasOne("dotnet_rest_api.Models.ProjectPhase", null)
                        .WithMany("Tasks")
                        .HasForeignKey("PhaseId")
                        .OnDelete(DeleteBehavior.SetNull);
