...
namespace dotnet_rest_api.Migrations
{
    ...
    [Migration("20260711180629_Phase5_AddImagesWeeklyRefreshTokens")]
    partial class Phase5_AddImagesWeeklyRefreshTokens
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dotnet_rest_api.Models.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("dotnet_rest_api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            PasswordHash = "$2a$11$OMrjsU5wl02tYlgxX4g9Eu7RuRDcjM2H4hZvDKOdi8YMDNSbMpuey",
                            RoleId = 1,
                            Username = "admin"
                        },
                        new
            ...
            modelBuilder.Entity("dotnet_rest_api.Models.WbsTask", b =>
                {
            ...
            modelBuilder.Entity("dotnet_rest_api.Models.WbsTaskDependency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("DependentTaskId")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("PrerequisiteTaskId")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.ToTable("WbsTaskDependencies");
                });

            modelBuilder.Entity("dotnet_rest_api.Models.WbsTaskEvidence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("dotnet_rest_api.Models.WbsTask", b =>
                {
                    b.HasOne("dotnet_rest_api.Models.User", "AssignedUser")
                        .WithMany()
                        .HasForeignKey("AssignedUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("dotnet_rest_api.Models.WbsTask", "ParentTask")
                        .WithMany("ChildTasks")
            ...
            modelBuilder.Entity("dotnet_rest_api.Models.WbsTaskDependency", b =>
                {
                    b.HasOne("dotnet_rest_api.Models.WbsTask", "DependentTask")
                        .WithMany("Dependencies")
                        .HasForeignKey("DependentTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("dotnet_rest_api.Models.WbsTask", "PrerequisiteTask")
            ...
            modelBuilder.Entity("dotnet_rest_api.Models.WbsTaskEvidence", b =>
                {
                    b.HasOne("dotnet_rest_api.Models.WbsTask", "WbsTask")
                        .WithMany("Evidence")
